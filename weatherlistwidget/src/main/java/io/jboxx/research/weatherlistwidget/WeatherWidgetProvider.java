...
public class WeatherWidgetProvider extends AppWidgetProvider {
    public static String CLICK_ACTION = "io.jboxx.research.weatherlistwidget.CLICK";
    public static String REFRESH_ACTION = "io.jboxx.research.weatherlistwidget.REFRESH";
    public static String EXTRA_DAY_ID = "io.jboxx.research.weatherlistwidget.day";
